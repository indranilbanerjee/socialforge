...
25 commands, 17 skills, 5 agents, 22 Python scripts, an opt-in catalog of 10 HTTP MCP connectors (Notion, Canva, Slack, Gmail, Google Calendar, Figma, fal.ai, Replicate, Asana, Cloudinary — all Cowork-compatible). Multi-plugin coexistence by design (zero global hooks).
